...
import { VeradoMatchMediaService } from '@verado/services/match-media.service';

@Directive({
    selector: '.inner-scroll'
})
export class VeradoInnerScrollDirective implements OnInit, OnDestroy
{
    // Private
    private _parent: any;
     ...
     * @param {VeradoMatchMediaService} _veradoMediaMatchService
     * @param {Renderer2} _renderer
     */
    constructor(
        private _elementRef: ElementRef,
        private _veradoMediaMatchService: VeradoMatchMediaService,
    ...
    ngOnInit(): void
    {
        ...
        this._veradoMediaMatchService.onMediaChange
