...
export class VeradoSidebarComponent implements OnInit, OnDestroy
{
    ...
    ngOnInit(): void
    {
        ...
        this._veradoConfigService.config
            ...
            .subscribe((config) => {
                this._veradoConfig = config;
            });

        // Register the sidebar
        this._veradoSidebarService.register(this.name, this);
    ...
    ngOnDestroy(): void
    {
        ...
        this._veradoSidebarService.unregister(this.name);
    ...
    private _showBackdrop(): void
    {
        ...
        this._backdrop.classList.add('verado-sidebar-overlay');

        // Add a class depending on the invisibleOverlay option
        if ( this.invisibleOverlay )
        {
            this._backdrop.classList.add('verado-sidebar-overlay-invisible');
        }
