...
import { VeradoMatSidenavHelperService } from '@verado/directives/verado-mat-sidenav/verado-mat-sidenav.service';
...
export class ChatChatsSidenavComponent implements OnInit, OnDestroy
{
    ...
    getChat(contact): void
    {
        ...
        {
            this._veradoMatSidenavHelperService.getSidenav('chat-left-sidenav').toggle();
        }
    }
